...
public abstract class DB
{
	 ...
	 * @param key_strs The record key of the record to read.
	...
	public abstract Status read(String table, List<String> key_strs, Set<String> fields, HashMap<ByteBuffer, HashMap<String, ByteIterator>> result);
	 ...
	 * @return The result of the operation.
	 */
	public abstract Status update(String table, List<String> key_strs, HashMap<String,ByteIterator> values);
	 ...
	 *
	 * @param table The name of the table
	 * @param key_strs The record keys of the records to insert.
	 * @param values A HashMap of field/value pairs to insert in the record
	 * @param isLoading specifies if this insert for loading phase
	 * @return The result of the operation.
	 */
	public abstract Status insert(String table, List<String> key_strs, HashMap<String,ByteIterator> values, boolean isLoading);
