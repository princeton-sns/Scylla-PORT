...
public:
    ...
    mutation_source as_mutation_source(uint32_t version_to_read = 0) const;
...
public:
    ...
    void apply(const frozen_mutation& m, const schema_ptr& m_schema, db::rp_handle&& = {}, lw_shared_ptr<uint32_t> commit_version_ptr = {});
...
private:
    ...
    future<> apply_in_memory(const frozen_mutation& m, schema_ptr m_schema, db::rp_handle&&, timeout_clock::time_point timeout, lw_shared_ptr<uint32_t> commit_version_ptr = {});
...
private:
    ...
    future<> do_apply(schema_ptr, const frozen_mutation&, timeout_clock::time_point timeout, lw_shared_ptr<uint32_t> commit_version_ptr = {});
    future<> apply_with_commitlog(schema_ptr, column_family&, utils::UUID, const frozen_mutation&, timeout_clock::time_point timeout, lw_shared_ptr<uint32_t> commit_version_ptr = {});
...
public:
    ...
    future<> apply(schema_ptr, const frozen_mutation&, timeout_clock::time_point timeout = timeout_clock::time_point::max(), lw_shared_ptr<uint32_t> commit_version_ptr = {});
