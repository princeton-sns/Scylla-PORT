...
public:
    uint32_t most_recent_version = 0;  // for piggybacking current version to client
                                       // it is set after each read, a new cell object will be created and
                                       // stores updated most_recent_version, see get_cell() below
