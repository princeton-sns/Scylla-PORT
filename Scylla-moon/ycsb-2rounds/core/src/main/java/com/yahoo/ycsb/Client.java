...
public class Client
{
  ...
  // new properties for scylla-moon experiments
  // number of keys per rotxn and/or batch_mutate
  public static final String KEYS_PER_OP_PROPERTY = "keysperop";
  public static final String KEYS_PER_OP_PROPERTY_DEFAULT = "5";
